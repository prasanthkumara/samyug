! function(t, e, n) {
    ...
    function X(t, e) {
        var n, r, i = vr.length;
        for (t = er(t), r = 0; i > r; ++r)
            if (n = vr[r] + e, w(n = t.attr(n))) return n;
        return null
    }
    ...
    function Z(t, e) {
        ...
        }), n && (i.strictDi = null !== X(n, "strict-di"), e(n, r ? [r] : [], i))
    }
    ...
    function Q(n, r, i) {
        ...
        return t && u.test(t.name) && (i.debugInfoEnabled = !0, t.name = t.name.replace(u, "")), t && !c.test(t.name) ? s() : (t.name = t.name.replace(c, ""), cr.resumeBootstrap = function(t) {
    ...
    function rt() {
        ...
        gr || (nr = t.jQuery, nr && nr.fn.on ? (er = nr, f(nr.fn, {
            ...
            if (fr) fr = !1;
                ...
                for (var r, i = 0; null != (r = t[i]); i++) n = nr._data(r, "events"), n && n.$destroy && nr(r).triggerHandler("$destroy");
            e(t)
    ...
    function ot(t, e, n) {
        return n && hr(t) && (t = t[t.length - 1]), it(C(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)), t
    }
    ...
    function gt(t, e) {
        ...
        if (vt(t)) u.push(e.createTextNode(t));
            ...
            for (n = n || s.appendChild(e.createElement("div")), r = (Ir.exec(t) || ["", ""])[1].toLowerCase(), i = Vr[r] || Vr._default, n.innerHTML = i[1] + t.replace(Rr, "<$1></$2>") + i[2], a = i[0]; a--;) n = n.lastChild;
    ...
    function Ct(t, e, n, r) {
        ...
        if (s)
            if (e) o(e.split(" "), function(e) {
                ...
                for (e in a) "$destroy" !== e && Tr(t, e, s), delete a[e]
    }
    ...
    function St(t, e) {
        ...
        if (i) {
            ...
            i.handle && (i.events.$destroy && i.handle({}, "$destroy"), Ct(t)), delete Er[r], t.ng339 = n
        }
    }
    ...
    function Bt(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e) throw w(n) && n || (n = t.name || _t(t)), zr("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
                    i = t.toString().replace(Wr, ""), a = i.match(_r), o(a[1].split(Br), function(t) {
    ...
    function Lt(t, e) {
        ...
        var g = {},
            ...
            k = E.$injector = $(E, function(t, e) {
                throw cr.isString(e) && x.push(e), zr("unpr", "Unknown provider: {0}", x.join(" <- "))
            }),
            A = {},
    ...
    function Gt(t, e, r, i) {
        ...
        function f() {
            T = l(), T = m(T) ? null : T, U(T, I) && (T = I), I = T
        }
        ...
        var T, D, O = g.href,
            M = e.find("base"),
            j = null;
        f(), D = T, $.url = function(e, n, r) {
            if (m(r) && (r = null), g !== t.location && (g = t.location), y !== t.history && (y = t.history), e) {
                var o = D === r;
                if (O === e && (!i.history || o)) return $;
                var a = O && be(O) === be(e);
                return O = e, D = r, !i.history || a && o ? (a || (j = e), n ? g.replace(e) : a ? g.hash = s(e) : g.href = e) : (y[n ? "replaceState" : "pushState"](r, "", e), f(), D = T), $
            }
        ...
        $.onUrlChange = function(e) {
            return N || (i.history && er(t).on("popstate", c), er(t).on("hashchange", c), N = !0), P.push(e), e
        ...
        $.cookies = function(t, e) {
            ...
            if (!t) {
                if (v.cookie !== V)
                    for (V = v.cookie, o = V.split("; "), R = {}, s = 0; s < o.length; s++) a = o[s], u = a.indexOf("="), u > 0 && (t = d(a.substring(0, u)), R[t] === n && (R[t] = d(a.substring(u + 1))));
                return R
            }
    ...
    function Xt(t, r) {
        ...
        this.debugInfoEnabled = function(t) {
        ...
        }, this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(t, r, i, u, v, g, S, E, A, T, D) {
            function O(t, e) {
                try {
                    t.addClass(e)
                } catch (n) {}
            ...
            function M(t, e, n, r, i) {
                ...
                return function(e, n, r) {
                    ...
                    var c;
                    if (c = "html" !== s ? er(Z(s, er("<div>").append(t).html())) : n ? Ur.clone.call(t) : t, o)
            ...
            function P(t, e, r, i, o, a) {
                function s(t, r, i, o) {
                    ...
                    for (l = 0, f = $.length; f > l;) u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), M.$$addScopeInfo(er(u), c)) : c = t, d = a.transcludeOnThisElement ? R(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? R(t, e) : null, a(s, c, u, i, d)) : s && s(t, u.childNodes, n, o)
                }
                for (var u, c, l, f, h, d, p, $ = [], v = 0; v < t.length; v++) u = new at, c = V(t[v], [], u, 0 === v ? i : n, o), l = c.length ? _(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && M.$$addScopeClass(u.$$element), h = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : P(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || h) && ($.push(v, l, h), d = !0, p = p || l), a = null;
                return d ? s : null
            }
                ...
                switch (s) {
                    case yr:
                        ...
                        for (var f, h, d, p, $, v, m = t.attributes, g = 0, b = m && m.length; b > g; g++) {
                            var x = !1,
                                C = !1;
                            f = m[g], h = f.name, $ = dr(f.value), p = Zt(h), (v = ft.test(p)) && (h = h.replace(Kr, "").substr(8).replace(/_(.)/g, function(t, e) {
                                return e.toUpperCase()
                            }));
                            var S = p.replace(/(Start|End)$/, "");
                            z(S) && p === S + "Start" && (x = h, C = h.substr(0, h.length - 5) + "end", h = h.substr(0, h.length - 6)), d = Zt(h.toLowerCase()), u[d] = h, (v || !n.hasOwnProperty(d)) && (n[d] = $, Rt(t, d) && (n[d] = !0)), tt(t, e, $, d, v), L(e, d, "A", r, i, x, C)
                        }
                        if (a = t.className, y(a) && (a = a.animVal), w(a) && "" !== a)
                            for (; o = l.exec(a);) d = Zt(o[2]), L(e, d, "C", r, i) && (n[d] = dr(o[3])), a = a.substr(o.index + o[0].length);
                        break;
                    case wr:
                        X(e, t.nodeValue);
                        break;
                    case br:
                        try {
                            o = c.exec(t.nodeValue), o && (d = Zt(o[1]), L(e, d, "M", r, i) && (n[d] = dr(o[2])))
                        } catch (E) {}
                }
                return e.sort(J), e
            }
            ...
            function q(t, e, n) {
                ...
                if (e && t.hasAttribute && t.hasAttribute(e)) {
                    do {
                        ...
                        t.nodeType == yr && (t.hasAttribute(e) && i++, t.hasAttribute(n) && i--), r.push(t), t = t.nextSibling
                    } while (i > 0)
                } else r.push(t);
                return er(r)
            }
            ...
            function _(t, a, s, u, c, l, f, h, d) {
                ...
                function b(t, e, i, u, c) {
                    function l(t, e, r) {
                        var i;
                        return k(t) || (r = e, e = t, t = n), z && (i = b), r || (r = z ? C.parent() : C), c(t, e, i, r, D)
                    }
                    var d, p, m, y, w, b, x, C, E;
                    if (a === i ? (E = s, C = s.$$element) : (C = er(i), E = new at(C, s)), N && (w = e.$new(!0)), c && (x = l, x.$$boundTransclude = c), P && (S = {}, b = {}, o(P, function(t) {
                            var n, r = {
                            ...
                            y = t.controller, "@" == y && (y = E[t.name]), n = g(y, r, !0, t.controllerAs), b[t.name] = n, z || C.data("$" + t.name + "Controller", n.instance), S[t.name] = n
                        })), N) {
                        M.$$addScopeInfo(C, w, !0, !(I && (I === N || I === N.$$originalDirective))), M.$$addScopeClass(C, !0);
                        var A = S && S[N.name],
                            T = w;
                        A && A.identifier && N.bindToController === !0 && (T = A.instance), o(w.$$isolateBindings = N.$$isolateBindings, function(t, n) {
                            ...
                            switch (l) {
                                ...
                                case "=":
                                    if (c && !E[u]) return;
                                    o = v(E[u]), s = o.literal ? U : function(t, e) {
                                        return t === e || t !== t && e !== e
                                    }, a = o.assign || function() {
                                        throw i = T[n] = o(e), Jr("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", E[u], N.name)
                                    }, i = T[n] = o(e);
                                    var f = function(t) {
                    ...
                    var D = e;
                    for (N && (N.template || null === N.templateUrl) && (D = w), t && t(D, i.childNodes, n, c), d = h.length - 1; d >= 0; d--) m = h[d], ot(m, m.isolateScope ? w : e, C, E, m.require && $(m.directiveName, m.require, C, b), x)
                }
                d = d || {};
                for (var x, S, E, A, T, D, O, j = -Number.MAX_VALUE, P = d.controllerDirectives, N = d.newIsolateScopeDirective, I = d.templateDirective, R = d.nonTlbTranscludeDirective, _ = !1, L = !1, z = d.hasElementTranscludeDirective, J = s.$$element = er(a), X = l, Q = u, tt = 0, nt = t.length; nt > tt; tt++) {
                    ...
                    if ((O = E.scope) && (E.templateUrl || (y(O) ? (K("new/isolated scope", N || x, E, J), N = E) : K("new/isolated scope", N, E, J)), x = x || E), A = E.name, !E.templateUrl && E.controller && (O = E.controller, P = P || {}, K("'" + A + "' controller", P[A], E, J), P[A] = E), (O = E.transclude) && (_ = !0, E.$$tlb || (K("transclusion", R, E, J), R = E), "element" == O ? (z = !0, j = E.priority, T = J, J = s.$$element = er(e.createComment(" " + A + ": " + s[A] + " ")), a = J[0], et(c, F(T), a), Q = M(T, u, j, X && X.name, {
                            nonTlbTranscludeDirective: R
                        })) : (T = er(bt(a)).contents(), J.empty(), Q = M(T, u))), E.template)
                        if (L = !0, K("template", I, E, J), I = E, O = C(E.template) ? E.template(J, s) : E.template, O = lt(O), E.replace) {
                            if (X = E, T = vt(O) ? [] : te(Z(E.templateNamespace, dr(O))), a = T[0], 1 != T.length || a.nodeType !== yr) throw Jr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", A, "");
                            et(c, J, a);
                            var ut = {
                                    $attr: {}
                                },
                            ...
                            N && B(ct), t = t.concat(ct).concat(ft), G(s, ut), nt = t.length
                        } else J.html(O);
                    if (E.templateUrl) L = !0, K("template", I, E, J), I = E, E.replace && (X = E), b = Y(t.splice(tt, t.length - tt), J, s, c, _ && Q, f, h, {
                        ...
                        D = E.compile(J, s, Q), C(D) ? p(null, D, it, st) : D && p(D.pre, D.post, it, st)
                    } catch (ht) {
                        i(ht, W(J))
                    }
                    E.terminal && (b.terminal = !0, j = Math.max(j, E.priority))
                }
                return b.scope = x && x.scope === !0, b.transcludeOnThisElement = _, b.elementTranscludeOnThisElement = z, b.templateOnThisElement = L, b.transclude = Q, d.hasElementTranscludeDirective = z, b
            }
            ...
            function Y(t, e, n, r, i, a, s, c) {
                ...
                return e.empty(), u(A.getTrustedResourceUrl(m)).then(function(u) {
                        var d, w, b, x;
                        if (u = lt(u), $.replace) {
                            if (b = vt(u) ? [] : te(Z(g, dr(u))), d = b[0], 1 != b.length || d.nodeType !== yr) throw Jr("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, m);
                            w = {
                                $attr: {}
                            }, et(r, e, d);
                            var C = V(d, [], w);
                            y($.scope) && B(C), t = C.concat(t), G(n, w)
                        } else d = p, e.html(u);
                        for (t.unshift(v), l = _(t, d, n, i, e, $, a, s, c), o(r, function(t, n) {
                            ...
                            if (!S.$$destroyed) {
                                if (E !== p) {
                                    var D = E.className;
                                    c.hasElementTranscludeDirective && $.replace || (T = bt(d)), et(k, er(E), T), O(er(T), D)
                                }
                                x = l.transcludeOnThisElement ? R(S, l.transclude, A) : A, l(f, S, T, r, x)
                            }
                        }
                        h = null
                    }),
            ...
            function et(t, n, r) {
                ...
                for (var d = 1, p = n.length; p > d; d++) {
                    var $ = n[d];
                    er($).remove(), h.appendChild($), delete n[d]
                }
                n[0] = r, n.length = 1
            }
                ...
                $set: function(t, e, r, a) {
                    ...
                    if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = nt(t, "-"))), s = N(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t) this[t] = e = D(e, "src" === t);
                        ...
                        for (var h = "", d = dr(e), p = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, $ = /\s/.test(d) ? p : /(,)/, v = d.split($), m = Math.floor(v.length / 2), g = 0; m > g; g++) {
                            var y = 2 * g;
                            h += D(dr(v[y]), !0), h += " " + dr(v[y + 1])
                        }
                        var w = dr(v[2 * g]).split(/\s/);
                        h += D(dr(w[0]), !0), 2 === w.length && (h += " " + dr(w[1])), this[t] = e = h
                    }
    ...
    function ae(t) {
        var e, n, r, i = ct();
        return t ? (o(t.split("\n"), function(t) {
            r = t.indexOf(":"), e = Jn(dr(t.substr(0, r))), n = dr(t.substr(r + 1)), e && (i[e] = i[e] ? i[e] + ", " + n : n)
        }), i) : i
    }
    ...
    function le() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, u, c, l, h, d) {
            function p(e) {
                function i(t) {
                    var e = f({}, t);
                    return e.data = t.data ? ue(t.data, t.headers, t.status, u.transformResponse) : t.data, ce(t.status) ? e : h.reject(e)
                }
            ...
            function b(r, i) {
                ...
                var d, $, v = h.defer(),
                    ...
                    b = r.headers,
                    x = S(r.url, r.params);
                if (p.pendingRequests.push(r), w.then(f, f), !r.cache && !t.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (d = y(r.cache) ? r.cache : y(t.cache) ? t.cache : E), d && ($ = d.get(x), g($) ? M($) ? $.then(c, c) : hr($) ? s($[1], $[0], V($[2]), $[3]) : s($, 200, {}, "OK") : d.put(x, w)), m($)) {
    ...
    function de(t, e, r, i, a) {
        function s(t, e, n) {
            ...
            return r.type = "text/javascript", r.src = t, r.async = !0, o = function(t) {
                Tr(r, "load", o), Tr(r, "error", o), a.body.removeChild(r), r = null;
                var s = -1,
                    u = "unknown";
                        ...
                        t: do {
                            if (o = d.$$watchers)
                                for (c = o.length; c--;) try {
                                    if (t = o[c])
                                        if ((r = t.get(d)) === (i = t.last) || (t.eq ? U(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                            if (t === a) {
                                                l = !1;
                                                break t
                                            }
                                        } else l = !0, a = t, t.last = t.eq ? R(r, null) : r, t.fn(r, i === w ? r : i, d), 5 > g && (p = 4 - g, x[p] || (x[p] = []), x[p].push({
    ...
    function Xe() {
        ...
        this.resourceUrlWhitelist = function(e) {
            return arguments.length && (t = Ke(e)), t
        }, this.resourceUrlBlacklist = function(t) {
            return arguments.length && (e = Ke(t)), e
    ...
    function Qe() {
        this.$get = ["$window", "$document", function(t, e) {
            var n, r, i = {},
                o = h((/android (\d+)/.exec(Jn((t.navigator || {}).userAgent)) || [])[1]),
    ...
    function sn(t) {
        ...
        }], e("currency", fn), e("date", Sn), e("filter", un), e("json", En), e("limitTo", kn), e("lowercase", Ti), e("number", hn), e("orderBy", An), e("uppercase", Di)
    }
    ...
    function fn(t) {
        ...
        return function(t, n, r) {
            return m(n) && (n = e.CURRENCY_SYM), m(r) && (r = e.PATTERNS[1].maxFrac), null == t ? t : dn(t, e.PATTERNS[1], e.GROUP_SEP, e.DECIMAL_SEP, r).replace(/\u00A4/g, n)
        }
    }
    ...
    function Sn(t) {
        ...
        return function(n, r, i) {
            ...
            for (; r;) s = ki.exec(r), s ? (c = q(c, s, 1), r = c.pop()) : (c.push(r), r = null);
            return i && "UTC" === i && (n = new Date(n.getTime()), n.setMinutes(n.getMinutes() + n.getTimezoneOffset())), o(c, function(e) {
                a = Ei[e], u += a ? a(n, t.DATETIME_FORMATS) : e.replace(/(^'|'$)/g, "").replace(/''/g, "'")
            }), u
        }
    }
    ...
    function On(t, e, r, i, a) {
        ...
        s.$error = {}, s.$$success = {}, s.$pending = n, s.$name = a(e.name || e.ngForm || "")(r), s.$dirty = !1, s.$pristine = !0, s.$valid = !0, s.$invalid = !1, s.$submitted = !1, c.$addControl(s), s.$rollbackViewValue = function() {
            ...
            i.setClass(t, $o, vo + " " + Pi), s.$dirty = !1, s.$pristine = !0, s.$submitted = !1, o(u, function(t) {
                t.$setPristine()
            })
    ...
    function Wn(t) {
        function e(t, e, u) {
            e === n ? r("$pending", t, u) : i("$pending", t, u), O(e) ? e ? (f(s.$error, t, u), l(s.$$success, t, u)) : (l(s.$error, t, u), f(s.$$success, t, u)) : (f(s.$error, t, u), f(s.$$success, t, u)), s.$pending ? (o(yo, !0), s.$valid = s.$invalid = n, a("", null)) : (o(yo, !1), s.$valid = zn(s.$error), s.$invalid = !s.$valid, a("", s.$valid));
            var c;
    ...
    var tr, er, nr, rr, ir = [].slice,
        ...
        lr = 0;
    tr = e.documentMode, p.$inject = [], $.$inject = [];
    var fr, hr = Array.isArray,
        dr = function(t) {
            return w(t) ? t.trim() : t
        },
        pr = function(t) {
    ...
    Vr.optgroup = Vr.option, Vr.tbody = Vr.tfoot = Vr.colgroup = Vr.caption = Vr.thead, Vr.th = Vr.td;
    var Ur = wt.prototype = {
            ready: function(n) {
                function r() {
                    i || (i = !0, n())
        ...
        on: function Go(t, e, n, r) {
            ...
            if (mt(t)) {
                ...
                for (var s = e.indexOf(" ") >= 0 ? e.split(" ") : [e], u = s.length; u--;) {
                    e = s[u];
                    var c = o[e];
                    c || (o[e] = [], "mouseenter" === e || "mouseleave" === e ? Go(t, Mr[e], function(t) {
                        var n = this,
                            r = t.relatedTarget;
            ...
            this.$$selectors = {}, this.register = function(e, n) {
                ...
                return {
                    ...
                    setClass: function(t, e, n, o) {
                        ...
                        var f = l.classes;
                        return e = hr(e) ? e : e.split(" "), n = hr(n) ? n : n.split(" "), a(f, e, !0), a(f, n, !1), c && (l.promise = r(function(e) {
                            var n = t.data(u);
                            if (t.removeData(u), n) {
                                var r = i(t, n.classes);
        ...
        functionCall: function(t, e) {
            ...
            return function(a, s) {
                var u = e ? e(a, s) : g(e) ? n : a,
                    c = t(a, s, u) || p;
                if (o)
                    for (var l = r.length; l--;) o[l] = Pe(r[l](a, s), i);
                Pe(u, i), Ne(c, i);
    ...
    var Ni = function(t) {
                        ...
                        return {
                            pre: function(t, r, i, a) {
                                ...
                                o && (Re(t, null, a.$name, a, a.$name), i.$observe(o, function(e) {
                                    ...
                                    u.$removeControl(a), o && Re(t, null, i[o], n, a.$name), f(a, ji)
                                })
                            }
                        }
                    }
        ...
        zi = {
            text: jn,
            date: Rn("date", Hi, In(Hi, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
            "datetime-local": Rn("datetimelocal", _i, In(_i, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"),
            time: Rn("time", Wi, In(Wi, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
            week: Rn("week", Bi, Nn, "yyyy-Www"),
            month: Rn("month", Li, In(Li, ["yyyy", "MM"]), "yyyy-MM"),
            number: Un,
            url: qn,
            email: Fn,
            radio: Hn,
        ...
        Xi = ["$interpolate", "$compile", function(t, e) {
            return {
                compile: function(r) {
    ...
    var so = ["$animate", function(t) {
        ...
        yo = "ng-pending",
        wo = new r("ngModel"),
        bo = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(t, e, r, i, a, s, u, c, l, f) {
        ...
        So = function() {
            return {
                ...
                controller: ["$scope", "$attrs", function(t, e) {
                    var r = this;
                    this.$options = t.$eval(e.ngModelOptions), this.$options.updateOn !== n ? (this.$options.updateOnDefault = !1, this.$options.updateOn = dr(this.$options.updateOn.replace(Co, function() {
                    ...
                    return y ? x = t(y) : (S = function(t, e) {
                        ...
                        function(t, e, r, h, $) {
                            ...
                            t.$watchCollection(m, function(r) {
                                var h, m, y, x, k, A, T, D, O, M, j, P, N = e[0],
                                    I = ct();
                                if (g && (t[g] = r), i(r)) O = r, D = C || S;
                                else {
                                    D = C || E, O = [];
                                    for (var R in r) r.hasOwnProperty(R) && "$" != R.charAt(0) && O.push(R);
                                    O.sort()
                                }
                                for (x = O.length, j = new Array(x), h = 0; x > h; h++)
                                    if (k = r === O ? h : O[h], A = r[k], T = D(k, A, h), v[T]) M = v[T], delete v[T], I[T] = M, j[h] = M;
                                    else {
                                ...
                                for (var V in v) {
                                    if (M = v[V], P = ut(M.clone), a.leave(P), P[0].parentNode)
                                        for (h = 0, m = P.length; m > h; h++) P[h][s] = !0;
                                    M.scope.$destroy()
                                }
                                for (h = 0; x > h; h++)
                                    if (k = r === O ? h : O[h], A = r[k], M = j[h], M.scope) {
                                        y = N;
                                        do y = y.nextSibling; while (y && y[s]);
                                        l(M) != y && a.move(ut(M.clone), null, er(N)), N = f(M), c(M.scope, h, w, A, b, k, x)
                                    } else $(function(t, e) {
                                        M.scope = e;
                                        var n = p.cloneNode(!1);
                                        t[t.length++] = n, a.enter(t, null, er(N)), N = n, M.clone = t, I[M.id] = M, c(M.scope, h, w, A, b, k, x)
                                    });
                                v = I
                            })
                        }
                ...
                link: function(s, u, c, l) {
                    ...
                    function d(e, s, u) {
                        ...
                        function d(t) {
                            ...
                            return function(n, r) {
                                var i;
                                return i = I ? I : D ? D : j, y ? g(e.remove(c(i, n, r))) : t === c(i, n, r)
                            }
                        }
                        ...
                        function m() {
                            x = !1;
                            var t, n, r, i, l, f, h, p, m, w, E, A, T, D, j, N, q, F = {
                                    "": []
                                },
                                H = [""],
                                _ = u.$viewValue,
                                ...
                                z = d(_),
                                G = !1;
                            for (R = {}, A = 0; w = L.length, w > A; A++) h = A, O && (h = L[A], "$" === h.charAt(0)) || (p = B[h], t = c(M, h, p) || "", (n = F[t]) || (n = F[t] = [], H.push(t)), T = z(h, p), G = G || T, N = c(k, h, p), N = g(N) ? N : "", q = I ? I(e, U) : O ? L[A] : A, I && (R[q] = h), n.push({
                                id: q,
                                label: N,
                                selected: T
                            }));
                            for (y || (b || null === _ ? F[""].unshift({
                                ...
                                for (t = H[E], n = F[t], V.length <= E ? (i = {
                                        ...
                                        label: n.label
                                    }, l = [i], V.push(l), s.append(i.element)) : (l = V[E], i = l[0], i.label != t && i.element.attr("label", i.label = t)), D = null, A = 0, w = n.length; w > A; A++) r = n[A], (f = l[A + 1]) ? (D = f.element, f.label !== r.label && (v(W, f.label, !1), v(W, r.label, !0), D.text(f.label = r.label), D.prop("label", f.label)), f.id !== r.id && D.val(f.id = r.id), D[0].selected !== r.selected && (D.prop("selected", f.selected = r.selected), tr && D.prop("selected", f.selected))) : ("" === r.id && b ? j = b : (j = C.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {
                                    element: j,
                                    label: r.label,
                                    id: r.id,
                                    selected: r.selected
                                }), v(W, r.label, !0), D ? D.after(j) : i.element.append(j), D = j);
                                for (A++; l.length > A;) r = l.pop(), v(W, r.label, !1), r.element.remove()
                            }
                            for (; V.length > E;) {
                    ...
                    if (l[1]) {
                        for (var p, $ = l[0], v = l[1], y = c.multiple, w = c.ngOptions, b = !1, x = !1, C = er(e.createElement("option")), S = er(e.createElement("optgroup")), E = C.clone(), k = 0, A = u.children(), T = A.length; T > k; k++)
                            if ("" === A[k].value) {
                                p = b = A.eq(k);
                                break
                            }
    ...
    function(t, e, n) {
        ...
        if (e.mock.TzDate = function(t, n) {
                ...
                }), t.decorator("$animate", ["$delegate", "$$asyncCallback", "$timeout", "$browser", function(t, r, i, o) {
                    var a = {
                        queue: [],
                        cancel: t.cancel,
                        enabled: t.enabled,
    ...
    function(t, e, n) {
            ...
            this.study = function(u) {
                ...
                return V(u, d), u = m = g = null,
                    function(r, o, a) {
                        ...
                        o.$$inheritedValues && i(y, f(o.$$inheritedValues, $)), U(g, o.$$promises), o.$$values ? (b = i(y, f(o.$$values, $)), m.$$inheritedValues = f(o.$$values, $), s()) : (o.$$inheritedValues && (m.$$inheritedValues = f(o.$$inheritedValues, $)), o.then(s, u));
        ...
        function v(t, e, i) {
            ...
            function s(i, o) {
                var a, s, u, c, l;
                return a = i[2] || i[3], l = e.params[a], u = t.substring(h, i.index), s = o ? i[4] : i[4] || ("*" == i[1] ? ".*" : null), c = F.type(s || "string") || r(F.type("string"), {
        ...
        function g() {
            ...
            g.$$getDefaultValue = function(t) {
                ...
                return f = t, b = !1, c(), V(C, function(t, e) {
                    w[e] || (w[e] = new m(t))
                }), this
                ...
                function $(t, e, r, i) {
                    ...
                    return o = R(t.replace) ? t.replace : [], N(i) && o.push({
                        from: i,
                        to: n
                    }), a = d(o, function(t) {
                        return t.from
                ...
                function g(t) {
                    ...
                    return t = n(t), j(t) ? x.type.$normalize(t) : v()
                }
        ...
        function w(t, i) {
            ...
            function y(t, e) {
                return I(t) ? e = t : e.name = t, $(e), this
            }

            function w(t, i, o, s, h, p, $, g, y) {
                function w(e, n, r, o) {
                    var a = t.$broadcast("$stateNotFound", e, n, r);
                    if (a.defaultPrevented) return $.update(), D;
                ...
                function E(t, n, r, a, u, c) {
                    ...
                    return a && p.push(a), V(t.views, function(n, r) {
                ...
                return x.locals = {
                    ...
                    if (o.inherit && (n = u(p, n || {}, C.$current, v)), !v.params.$$validates(n)) return O;
                    ...
                    if (o.reload) {
                        if (N(o.reload) || I(o.reload)) {
                            ...
                            for (V = !0; M && M === d[D] && M !== F;) P = R[D] = M.locals, D++, M = S[D]
                        }
                    } else
                        for (; M && M === d[D] && M.ownParams.$$equals(n, h);) P = R[D] = M.locals, D++, M = S[D];
                    if (!V && b(e, c, P, o)) return e.self.reloadOnSearch !== !1 && $.update(), C.transition = null, i.when(C.current);
                    if (n = l(e.params.$$keys(), n || {}), o.notify && t.$broadcast("$stateChangeStart", e.self, n, c.self, h).defaultPrevented) return t.$broadcast("$stateChangeCancel", e.self, n, c.self, h), $.update(), T;
                    for (var H = i.when(P), _ = D; _ < S.length; _++, M = S[_]) P = R[_] = r(P), H = E(M, n, M === e, H, P, o);
                    var B = C.transition = H.then(function() {
                        var r, i, a;
                        if (C.transition !== B) return A;
                        for (r = d.length - 1; r >= D; r--) a = d[r], a.self.onExit && s.invoke(a.self.onExit, a.self, a.locals.globals), a.locals = null;
                        for (r = D; r < S.length; r++) i = S[r], i.locals = R[r], i.self.onEnter && s.invoke(i.self.onEnter, i.self, i.locals.globals);
                        return m && (n["#"] = m), C.transition !== B ? A : (C.$current = e, C.current = e.self, C.params = n, q(C.params, p), C.transition = null, o.location && e.navigable && $.push(e.navigable.url, e.navigable.locals.globals.$stateParams, {
                            $$avoidResync: !0,
        ...
        v.prototype.concat = function(t, e) {
            ...
            for (o = 0; u > o; o++) {
                ...
                if (l) {
                    var g = n[o + 1];
                    if (v === !1) null != m && (c += R(m) ? d(m, e).join("-") : encodeURIComponent(m)), c += g;
                    else if (v === !0) {
                        var y = c.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
                        c += g.match(y)[1]
                    } else N(v) && (c += v + g)
                    ...
                    R(m) || (m = [m]), m = d(m, encodeURIComponent).join("&" + f + "="), c += (a ? "&" : "?") + (f + "=" + m), a = !0
                }
            }
            return c
            ...
            return new r(this, t)
        }, e.module("ui.router.util").provider("$urlMatcherFactory", g), e.module("ui.router.util").run(["$urlMatcherFactory", function(t) {}]), y.$inject = ["$locationProvider", "$urlMatcherFactoryProvider"], e.module("ui.router.router").provider("$urlRouter", y), w.$inject = ["$urlRouterProvider", "$urlMatcherFactoryProvider"], e.module("ui.router.state").value("$stateParams", {}).provider("$state", w), b.$inject = [], e.module("ui.router.state").provider("$view", b), e.module("ui.router.state").provider("$uiViewScroll", x), C.$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate"], S.$inject = ["$compile", "$controller", "$state", "$interpolate"], e.module("ui.router.state").directive("uiView", C), e.module("ui.router.state").directive("uiView", S), T.$inject = ["$state", "$timeout"], D.$inject = ["$state", "$stateParams", "$interpolate"], e.module("ui.router.state").directive("uiSref", T).directive("uiSrefActive", D).directive("uiSrefActiveEq", D), O.$inject = ["$state"], M.$inject = ["$state"], e.module("ui.router.state").filter("isState", O).filter("includedByState", M)
        ...
        e.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function() {
            ...
            r.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function(t, n, r, v, b, x, C, S, E, k) {
                ...
                function P(t, n, r, i, o, a, s, u) {
                    ...
                    if (C = C && C.events, i || (i = o ? o.parent() : r.parent()), R(r, i)) return v(), d(), p(), g(), w;
                    var S = r.data(m) || {},
                        E = S.active || {},
                        k = S.totalActive || 0,
                        A = S.last,
                    ...
                    if (k > 0) {
                        var D = [];
                        if (b.isClassBased) {
                            if ("setClass" == A.event) D.push(A), I(r, n);
                            else if (E[n]) {
                                var O = E[n];
                ...
                return {
                    animate: function(t, e, n, r, i) {
                        return r = r || "ng-inline-animate", i = D(i) || {}, i.from = n ? e : null, i.to = n ? n : e, T(function(e) {
                            return P("animate", r, s(t), null, null, l, i, e)
                        })
                    },
                    enter: function(n, r, i, o) {
                        return o = D(o), n = e.element(n), r = a(r), i = a(i), A(n, !0), t.enter(n, r, i), T(function(t) {
                            return P("enter", "ng-enter", s(n), r, i, l, o, t)
                        })
                    },
                    leave: function(n, r) {
                        return r = D(r), n = e.element(n), N(n), A(n, !0), T(function(e) {
                    ...
                    move: function(n, r, i, o) {
                        return o = D(o), n = e.element(n), r = a(r), i = a(i), N(n), A(n, !0), t.move(n, r, i), T(function(t) {
                    ...
                    if (!n) {
                        ...
                        f(t, function(t) {
                            if (t.nodeType == v) {
                                ...
                                var c = y(e[j + R]);
                                c > 0 && (c *= parseInt(e[j + q], 10) || 1), a = Math.max(c, a)
                            }
                        }), n = {
                            total: 0,
                            transitionDelay: o,
                ...
                function w(t) {
                    var e = t.parent(),
                        n = e.data(H);
                    return n || (e.data(H, ++G), n = G), n + "-" + o(t).getAttribute("class")
                }
                ...
                function x(t, e, n, r, i) {
                    function s() {
                        e.off(U, u), c.removeClass(e, d), c.removeClass(e, p), R && a.cancel(R), T(e, n);
                        var t = o(e);
                    ...
                    if (0 === D) return c.removeClass(e, d), T(e, n), void r();
                    ...
                    if (m.length > 0) {
                        ...
                        ";" !== I.charAt(I.length - 1) && (I += ";"), l.setAttribute("style", I + " " + v)
                    }
                    var R, V = Date.now(),
                        U = P + " " + M,
                        q = (O + D) * L,
                    ...
                    return b > 0 && (c.addClass(e, p), R = a(function() {
                        R = null, A.transitionDuration > 0 && C(l, !1), A.animationDuration > 0 && S(l, !1), c.addClass(e, d), c.removeClass(e, p), i && (0 === A.transitionDuration && e.css("transition", A.animationDuration + "s linear all"), e.css(i), m.push("transition"))
                    }, b * W, !1)), e.on(U, u), h.closeAnimationFns.push(function() {
                        s(), r()
                    }), h.running++, $(e, F), s
                }
                ...
                var O, M, j, P, N = "";
                t.ontransitionend === n && t.onwebkittransitionend !== n ? (N = "-webkit-", O = "WebkitTransition", M = "webkitTransitionEnd transitionend") : (O = "transition", M = "transitionend"), t.onanimationend === n && t.onwebkitanimationend !== n ? (N = "-webkit-", j = "WebkitAnimation", P = "webkitAnimationEnd animationend") : (j = "animation", P = "animationend");
                var I, R = "Duration",
                    V = "Property",
                    U = "Delay",
                    q = "IterationCount",
                ...
                return {
                    ...
                    setClass: function(t, e, n, r, i) {
                        i = i || {}, n = D(n, "-remove"), e = D(e, "-add");
                        var o = n + " " + e;
                        return k("setClass", t, o, r, i.to)
                    },
                    addClass: function(t, e, n, r) {
                        return r = r || {}, k("addClass", t, D(e, "-add"), n, r.to)
                    },
                    removeClass: function(t, e, n, r) {
                        return r = r || {}, k("removeClass", t, D(e, "-remove"), n, r.to)
                    }
                }
            }])
        }])
        ...
        var n = n || function(n) {
            var r = {
                ...
                a = {
                    ...
                    vendor: function() {
                        var t, n = e.createElement("div"),
                            r = "webkit Moz O ms".split(" ");
                        for (t in r)
                            if ("undefined" != typeof n.style[r[t] + "Transition"]) return r[t]
                    },
                    ...
                    deepExtend: function(t, e) {
                        var n;
                        for (n in e) e[n] && e[n].constructor && e[n].constructor === Object ? (t[n] = t[n] || {}, a.deepExtend(t[n], e[n])) : t[n] = e[n];
                        return t
                    },
                    angleOfDrag: function(t, e) {
                        var n, r;
                        return r = Math.atan2(-(i.startDragY - e), i.startDragX - t), 0 > r && (r += 2 * Math.PI), n = Math.floor(r * (180 / Math.PI) - 180), 0 > n && n > -180 && (n = 360 - Math.abs(n)), Math.abs(n)
                    },
                    events: {
                ...
                s = {
                    translate: {
                        ...
                        easeCallback: function() {
                            r.element.style[i.vendor + "Transition"] = "", i.translation = s.translate.get.matrix(4), i.easing = !1, clearInterval(i.animatingInterval), 0 === i.easingTo && (a.klass.remove(e.body, "snapjs-right"), a.klass.remove(e.body, "snapjs-left")), a.dispatchEvent("animated"), a.events.removeEvent(r.element, a.transitionCallback(), s.translate.easeCallback)
                        },
                        easeTo: function(t) {
                            ...
                            }, 1), a.events.addEvent(r.element, a.transitionCallback(), s.translate.easeCallback), s.translate.x(t)) : (i.translation = t, s.translate.x(t)), 0 === t && (r.element.style[i.vendor + "Transform"] = "")
                        },
                        x: function(n) {
                            if (!("left" === r.disable && n > 0 || "right" === r.disable && 0 > n))
                                if (r.hyperextensible || (n === r.maxPosition || n > r.maxPosition ? n = r.maxPosition : (n === r.minPosition || n < r.minPosition) && (n = r.minPosition)), n = parseInt(n, 10), isNaN(n) && (n = 0), a.canTransform()) {
                                    var o = "translate3d(" + n + "px, 0,0)";
                                    r.element.style[i.vendor + "Transform"] = o
                                } else r.element.style.width = (t.innerWidth || e.documentElement.clientWidth) + "px", r.element.style.left = n + "px", r.element.style.right = ""
                        }
                    },
                    drag: {
                        listen: function() {
                            i.translation = 0, i.easing = !1, a.events.addEvent(r.element, a.eventType("down"), s.drag.startDrag), a.events.addEvent(r.element, a.eventType("move"), s.drag.dragging), a.events.addEvent(r.element, a.eventType("up"), s.drag.endDrag)
                        },
                        stopListening: function() {
                            a.events.removeEvent(r.element, a.eventType("down"), s.drag.startDrag), a.events.removeEvent(r.element, a.eventType("move"), s.drag.dragging), a.events.removeEvent(r.element, a.eventType("up"), s.drag.endDrag)
                        },
                        startDrag: function(t) {
                            ...
                            a.dispatchEvent("start"), r.element.style[i.vendor + "Transition"] = "", i.isDragging = !0, i.hasIntent = null, i.intentChecked = !1, i.startDragX = a.page("X", t), i.startDragY = a.page("Y", t), i.dragWatchers = {
                                current: 0,
                                last: 0,
                                hold: 0,
                                state: ""
                        ...
                        dragging: function(t) {
                            if (i.isDragging && r.touchToDrag) {
                                ...
                                if (r.addBodyClasses && (l > 0 ? (a.klass.add(e.body, "snapjs-left"), a.klass.remove(e.body, "snapjs-right")) : 0 > l && (a.klass.add(e.body, "snapjs-right"), a.klass.remove(e.body, "snapjs-left"))), i.hasIntent === !1 || null === i.hasIntent) {
                                    ...
                                    i.hasIntent = v || $ ? !0 : !1, i.intentChecked = !0
                                }
                                if (r.minDragDistance >= Math.abs(o - i.startDragX) || i.hasIntent === !1) return;
                                a.events.prevent(t), a.dispatchEvent("drag"), i.dragWatchers.current = o, i.dragWatchers.last > o ? ("left" !== i.dragWatchers.state && (i.dragWatchers.state = "left", i.dragWatchers.hold = o), i.dragWatchers.last = o) : i.dragWatchers.last < o && ("right" !== i.dragWatchers.state && (i.dragWatchers.state = "right", i.dragWatchers.hold = o), i.dragWatchers.last = o), h ? (r.maxPosition < l && (n = (l - r.maxPosition) * r.resistance, d = f - n), i.simpleStates = {
                                    opening: "left",
                        ...
                        endDrag: function(t) {
                            if (i.isDragging) {
                                ...
                                if (0 === i.dragWatchers.current && 0 !== e && r.tapToClose) return a.dispatchEvent("close"), a.events.prevent(t), s.translate.easeTo(0), i.isDragging = !1, void(i.startDragX = 0);
                                "left" === i.simpleStates.opening ? i.simpleStates.halfway || i.simpleStates.hyperExtending || i.simpleStates.flick ? i.simpleStates.flick && "left" === i.simpleStates.towards ? s.translate.easeTo(0) : (i.simpleStates.flick && "right" === i.simpleStates.towards || i.simpleStates.halfway || i.simpleStates.hyperExtending) && s.translate.easeTo(r.maxPosition) : s.translate.easeTo(0) : "right" === i.simpleStates.opening && (i.simpleStates.halfway || i.simpleStates.hyperExtending || i.simpleStates.flick ? i.simpleStates.flick && "right" === i.simpleStates.towards ? s.translate.easeTo(0) : (i.simpleStates.flick && "left" === i.simpleStates.towards || i.simpleStates.halfway || i.simpleStates.hyperExtending) && s.translate.easeTo(r.minPosition) : s.translate.easeTo(0)), i.isDragging = !1, i.startDragX = a.page("X", t)
                            }
                        }
                    }
                },
            ...
            this.open = function(t) {
                a.dispatchEvent("open"), a.klass.remove(e.body, "snapjs-expand-left"), a.klass.remove(e.body, "snapjs-expand-right"), "left" === t ? (i.simpleStates.opening = "left", i.simpleStates.towards = "right", a.klass.add(e.body, "snapjs-left"), a.klass.remove(e.body, "snapjs-right"), s.translate.easeTo(r.maxPosition)) : "right" === t && (i.simpleStates.opening = "right", i.simpleStates.towards = "left", a.klass.remove(e.body, "snapjs-left"), a.klass.add(e.body, "snapjs-right"), s.translate.easeTo(r.minPosition))
            }, this.close = function() {
                a.dispatchEvent("close"), s.translate.easeTo(0)
            }, this.expand = function(n) {
                var r = t.innerWidth || e.documentElement.clientWidth;
                "left" === n ? (a.dispatchEvent("expandLeft"), a.klass.add(e.body, "snapjs-expand-left"), a.klass.remove(e.body, "snapjs-expand-right")) : (a.dispatchEvent("expandRight"), a.klass.add(e.body, "snapjs-expand-right"), a.klass.remove(e.body, "snapjs-expand-left"), r *= -1), s.translate.easeTo(r)
            }, this.on = function(t, e) {
                return o[t] = e, this
            }, this.off = function(t) {
                o[t] && (o[t] = !1)
            }, this.enable = function() {
                a.dispatchEvent("enable"), s.drag.listen()
            }, this.disable = function() {
                a.dispatchEvent("disable"), s.drag.stopListening()
            }, this.settings = function(t) {
                a.deepExtend(r, t)
            }, this.state = function() {
                var t, e = s.translate.get.matrix(4);
    ...
    function() {
    ...
    }(), angular.module("snap").directive("snapClose", ["$rootScope", "snapRemote", function(t, e) {
        "use strict";
        return {
            restrict: "A",
            link: function(n, r, i) {
                r.bind("click", function() {
                    e.close(n.$eval(i.snapId)), t.$digest()
                })
            }
        }
    }]), angular.module("snap").directive("snapContent", ["SnapConstructor", "snapRemote", function(t, e) {
        "use strict";
        return {
            restrict: "AE",
            link: function(n, r, i) {
                ...
                var o = i.snapId;
                o && (o = n.$eval(i.snapId));
                var a = angular.extend({}, e.globalOptions),
                    s = function(t, r) {
                        n.$watch(function() {
                            return n.$eval(t)
                        }, function(t, n) {
                ...
                }), a.element = r[0], angular.isDefined(i.snapOptions) && i.snapOptions && angular.extend(a, n.$eval(i.snapOptions)), e.register(new t(a), o), angular.isDefined(i.snapOptions) && i.snapOptions && n.$watch(i.snapOptions, function(t) {
    ...
    }]), angular.module("snap").directive("snapDragger", ["snapRemote", function(t) {
        "use strict";
        return {
            restrict: "AE",
            link: function(e, n, r) {
        ...
        return {
            ...
            link: function(t, e, n) {
                ...
                var r = e.parent(),
                    i = !0;
                for (e.addClass("right" === n.snapDrawer ? "snap-drawer-right" : "snap-drawer-left"); r.length;) r.hasClass("snap-drawers") && (i = !1), r = r.parent();
    ...
    }), angular.module("snap").directive("snapToggle", ["$rootScope", "snapRemote", function(t, e) {
        "use strict";
        return {
            restrict: "A",
            link: function(n, r, i) {
                ...
                if (o && (o = n.$eval(o)), !i.snapUnsafe) {
                    ...
                    r.bind("mousedown", function(t) {
                        s = !0, t.stopImmediatePropagation()
                    }), r.bind("mouseup", function(t) {
                        s && t.stopImmediatePropagation(), s = !1
                    })
                }
                r.bind("click", function() {
                    e.toggle(a, o), t.$digest()
                })
            }
        }
        ...
        "use strict";
        var t = this;
        return this.globalOptions = {}, this.$get = ["$q", function(e) {
            var n, r, i = {},
                o = "__DEFAULT_SNAPPER_ID__",
                a = {};
            return a.globalOptions = t.globalOptions, a.getSnapper = function(t) {
                return t = t || o, i.hasOwnProperty(t) || n(t), i[t].deferred.promise
            }, a.register = function(t, e) {
                e = e || o, i.hasOwnProperty(e) || n(e), i[e].isResolved && n(e), r(t, e)
            }, a.unregister = function(t) {
                t = t || o, i.hasOwnProperty(t) && delete i[t]
            }, a.toggle = function(t, e) {
                e = e || o, a.getSnapper(e).then(function(n) {
                    t === n.state().state ? a.close(e) : a.open(t, e)
                })
            }, a.open = function(t, e) {
                e = e || o, a.getSnapper(e).then(function(e) {
                    e.open(t)
                })
            }, a.close = function(t) {
                t = t || o, a.getSnapper(t).then(function(t) {
                    t.close()
                })
                ...
                i[e].deferred.resolve(t), i[e].isResolved = !0
            }, a
        }], this
    });